...
var UpdateEmployee = function (props) {
    ...
    var _c = react_1.useState(props.birthDay), bithday = _c[0], setBirthday = _c[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { name: 'updateEmp', method: 'post', action: 'employee' },
            ...
            React.createElement("input", { name: 'Birthday', type: 'date', value: bithday, onChange: function (e) { return setBirthday(e.target.value); } }),
